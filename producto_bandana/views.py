...
def lista_productos(request):
	...
	template_name = 'producto_bandana/producto_bandana.html'
	return render(request, template_name, data)

def bandana(request):
	return render(request, 'producto_bandana/producto_bandana.html', {})

def producto_detalle(request):
	return render(request, 'producto_bandana/producto_detalle.html', {})

def categoria_alternativa(request):
	return render(request, 'producto_bandana/prod_alternativas.html', {})
